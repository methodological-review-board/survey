...
include-in-header:
  - text: |
      ...
      /* Logo MRB più grande (100px) su tutte le slide */
      .reveal .slide-logo {
      ...
      /* Nasconde il logo MRB SOLO nella title slide, anche se RevealJS lo carica dopo */
      .reveal #title-slide .slide-logo {
        display: none !important;
      }

      /* Loghi unificati centrati solo nella title slide */
      #title-slide::after {
        content: "";
        display: block;
