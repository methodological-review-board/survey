...
format: 
  revealjs:
    ...
    slide-number: true
    css: "stile.css"
    title-slide-class: "custom-title-slide"
...
## Creazione colonna 2 unendo 2.1, 2.2, 2.3
datacleaned$`2` <- apply(datacleaned[, c("2.1", "2.2", "2.3")], 1, function(x) {
...
::: main-title
Risultati di una survey sul Methodological Review Board
:::

::: subtitle-block
Tavola Rotonda 27 giugno 2025\
<br> [Laura Sità, Matteo Manente, Massimiliano Pastore]{.authors-line}
:::
...
```{r scr2.1b}
plot_confronto_gruppi("2", "Quantitativo")
```
...
```{r mrb15, out.width = "85%", fig.align = 'center'}
