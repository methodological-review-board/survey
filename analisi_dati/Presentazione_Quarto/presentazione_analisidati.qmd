---
title: "Risultati della survey su<br> Open Science e Methodological Review Board"
...
include-in-header:
  - text: |
      <style>
      /* Titolo nella slide iniziale */
      #title-slide .title {
        font-size: 2em;
        color: #118811;
      }

      /* Logo alternativo centrato solo nella title slide */
      #title-slide::after {
        content: "";
        display: block;
...
I cinque membri del DPSS affiliati al gruppo di ricerca Psicostat non risultano tra i partecipanti alla survey.
:::
...
-   [Informazioni demografiche](#INFORMAZIONI%20DEMOGRAFICHE)
-   [Screening](#SCREENING)
-   [Pratiche di Open Science](#OPEN%20SCIENCE)
-   [Opinioni sul Methodological Review Board](#MRB)
...
# Methodological<br>Review Board (MRB) {#mrb}
...
Presentazione e materiale completo alla [pagina del MRB](https://github.com/laurasitaunipd/mrb/tree/main/analisi_dati)

<br><br><br>

![](logo_UNITI.png){fig-align="center"}
