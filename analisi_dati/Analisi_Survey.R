...
plot_likert_completamente("12.1", "Aiuto per pre-registrare")
plot_likert_completamente("12.2", "Mi rivolgerei al MRB")

## Utilità MRB
plot_likert_completamente("13.1", "Punto di riferimento per ambito metodologico")
...
plot_frequenze("14", "Integrazione nel Comitato Etico")

## Partecipazione a tavola rotonda
plot_frequenze("16", "Partecipazione")


#################################### DESCRITTIVE DISAGGREGATE (Strutturati vs Non-Strutturati)
