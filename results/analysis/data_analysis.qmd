...
```{r copia}
html_source <- here::here("results/analysis/data_analysis.html")
html_dest <- here::here("docs/data_analysis.html")

if (file.exists(html_source)) {
  file.copy(html_source, html_dest, overwrite = TRUE)
  message("✅ HTML copiato in docs/data_analysis.html per GitHub Pages.")
} else {
  warning("⚠️ HTML NON trovato: ", html_source)
}
```
